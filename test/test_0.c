...
void test_0(){
   ...
   // void(*square_func_ptr)(void*) = &square_func;
    ...
    map(square_func, nums_1, sizeof(int), 5);
    for (int i = 0; i < 5; i++) {
  ...
  //  void(*cap_func_ptr)(void*) = &cap_func;
    ...
    map(cap_func, letters_1, sizeof(char), 32);
    ...
    filter(odd_func, nums_2, sizeof(int),10);
    for(int i = 0;i<5;i++) {
   ...
   // int(*space_func_ptr)(void*) = &space_func;
    ...
    filter(space_func, letters_2, sizeof(char),36);
    ...
    assert(reduce(sum_func, nums_3, sizeof(int),5) == 15);
   ...
   // int(*sort_func_ptr)(void*, void*) = &sort_func;
    ...
    sort(sort_func, nums_4, sizeof(int), 10);
    for(int i = 0; i <10;i++){
