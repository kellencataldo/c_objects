...
void test_1(){
    string_t string_1 = new_string("google", 6);
    string_t string_2 = new_string("https://www.google.com", 22);
    assert(!(  string_1->str_eq(string_1, string_2   )));

    assert( strcmp( string_1->char_string, "google" ) == 0);

    string_1->extend(string_1, ".com", 4);
    assert( strcmp( string_1->char_string, "google.com" ) == 0);

    string_1->extendl(string_1, "https://www.", 12);
    assert( strcmp( string_1->char_string, "https://www.google.com" ) == 0);
    ...
    string_1->dest(string_1);
    string_2->dest(string_2);
